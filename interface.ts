...
let user1 : User = {id: 1, name: "John", age: 18, email: "john@gmail.com"};
// user1.name;
// user1.email; // when we want to use it anywhere 
// we can also destructure it ==>
let {name , email} :User = user1;
...
let emp1 : Emp = {id: 2, name:"Ron", email: "ron234@gmai.com", salary: 20000}
